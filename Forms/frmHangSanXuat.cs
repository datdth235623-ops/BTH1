    ...
    public partial class frmHangSanXuat : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (xuLyThem)
                {
                    HangSanXuat thsx = new HangSanXuat();
                    thsx.TenHangSanXuat = txtTenHangSanXuat.Text;
                    context.HangSanXuat.Add(thsx);

                    context.SaveChanges();
                }
                else
                {
                    HangSanXuat thsx = context.HangSanXuat.Find(id);
                    if (thsx != null)
                    {
                        thsx.TenHangSanXuat = txtTenHangSanXuat.Text;
                        context.HangSanXuat.Update(thsx);
